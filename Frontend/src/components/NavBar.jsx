    ...
    <div className=' bg-[#f3f3f3] flex justify-center px-4 pt-6 '>
        ...
        className='w-full max-w-6xl bg-white rounded-3xl shadow-sm border border-gray-200 px-8 py-4 flex justify-between items-center relative '> 
            <div className='flex items-center gap-3 cursor-pointer'>
                ...
                <div className='font-semibold hidden md:block text-lg'>Interview.Ai</div>
            </div>
            <div className='flex items-center gap-6 relative'>
                <div className='relative'>
                    ...
                    {showCreditPopUp && (
                        <div className='absolute right-[-50%] mt-3 w-64 bg-white shadow-xl border border-gray-200 rounded-xl p-5 z-50 '>
